...
function TopPanel() {
  ...
  if (isArch) {
    return (
      ...
      >
        ...
        {/* Right - System info */}
        <div className="flex items-center gap-4">
          <span style={{ color: 'var(--text-muted)' }}>cpu 12%</span>
  ...
  return (
    ...
    >
      {/* Left Section - Activities / Distro Name */}
      ...
      <button
        className="absolute left-1/2 -translate-x-1/2 flex items-center gap-2 hover:bg-white/10 px-3 rounded transition-colors"
        style={{
          fontSize: '13px',
          height: 'calc(var(--panel-height) - 4px)',
          fontWeight: 500,
      ...
      <div className="flex items-center">
        {/* System Icons - grouped like GNOME */}
        <button
