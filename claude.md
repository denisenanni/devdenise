1. Think through the problem. Read the codebase and write a plan in tasks/todo.md.
...
5. At every step, give me an high level explanation of what you changed.
6. Keep every change simple anc minimal. Avoid big rewrites.
7. At the end, add a review section in todo.md summarizing the changes. If the todo.md file already exists, edit that.
